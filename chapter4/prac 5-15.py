...
cv2.createTrackbar("brightness", title, 100, 200, brightness_bar)  # 밝기 트랙바
cv2.createTrackbar("contrast", title, 100, 200, contrast_bar)  # 대비 트랙바
...
while True:
    ...
    put_string(frame, "contrast : ", (10, 330), contrast)  # 대비 값 표시
